...
$ch = curl_init($url);
if ($ch === false) {
  proxy_client_error(500, 'service-page', 'curl_init failed');
}
...
if ($responseBody === false || $statusCode < 200 || $statusCode >= 300) {
  proxy_client_error(502, 'service-page', 'Sanity request failed', [
...
if (!is_array($decoded) || !array_key_exists('result', $decoded)) {
  proxy_client_error(502, 'service-page', 'Unexpected Sanity response shape');
}
